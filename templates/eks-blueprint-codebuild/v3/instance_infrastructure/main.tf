...
module "eks_cluster" {
  ...
  argocd_secret_manager_name_suffix           = "argocd-admin-secret" #var.service_instance.inputs.argocd_secret_manager_name_suffix
  ...
  gitops_addons_basepath = "argocd/" #var.service_instance.inputs.gitops_addons_basepath
